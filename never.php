<table style="width: 100%;" cellspacing="0" cellpadding="0">
	...
	<option  value="Others">Others</option>
                                                                            ...
                                                                            <td align="left" width="55%">
																				<input name="seek" type="radio" value = "Yes" >Yes
																				<input name="seek" type="radio" value = "No" >No
                                                                            </td>
	...
	<option  value="Others">Others</option>
																		...
																		<tr>
                                                                            ...
                                                                            <td align="left" width="55%">
																				<input name="desire" type="radio" value = "Yes" >Yes
																				<input name="desire" type="radio" value = "No" >No
                                                                            </td>
																		...
																		<tr>
                                                                            ...
                                                                            <td align="left" width="55%">
																				<input name="consider" type="radio" value = "Yes" >Yes
																				<input name="consider" type="radio" value = "No" >No
                                                                            </td>
