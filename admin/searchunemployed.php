...
<body>
<form method="post" action="searchunemployed.php" autocomplete="on">
                    ...
                    <div class="mid">
                        <div id="main">
                                     ...
                                     <a href="employed.php" class = "btn btn-danger">Back</a>
                                                          ...
                                                          <div class="form_tab">
                                                              Never Employed Students</div><br/>
                                                            <fieldset>
                                                                <center>
																
                                                          
                                                                        
                                                                    <table cellspacing="1"border = "1"  cellpadding="0" width="100%">
                                                                      <thead>
										  <tr>
												...
												<th>Consider CSU as a Factor</th>
																								<th>Action</th>
										   </tr>
										</thead>
										<tbody>
													<?php
													$user_query = mysqli_query($conn,"select * from unemployed where fullname = '$name' order by fullname asc")or die(mysqli_error());
