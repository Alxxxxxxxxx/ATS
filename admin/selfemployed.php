                ...
                <div class="mid-inner">
                    <div class="mid">
                        <div id="main">
                                                ...
                                                <table style="width: 100%;" cellspacing="0" cellpadding="0">
                                                    <tbody><tr>
                                                        <td align="left">
														 <div align="right">
														 <br/>
                                         Search Student Name: <input type = "text">
                                        </div>
                                                          <div class="form_tab">
                                                              Self-Employed Students</div>
                                                            <fieldset>
                                                                <center>
										...
										<tbody>
													<?php
													$user_query = mysqli_query($conn,"select * from selfemployed order by fullname asc")or die(mysqli_error());
													while($row = mysqli_fetch_array($user_query)){
													$id = $row['self_employed_data_id'];
													?>
